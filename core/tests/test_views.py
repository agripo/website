...
class AnyViewTest(TestCase):
    ...
    def test_cookie_notification_shown_variable_in_context_at_startup(self):
        ...
        self.assertFalse(
            response.context['cookies_notification_shown'],
            "The context variable cookies_notification_shown should be False at startup")
    ...
    def test_cookie_notification_shown_variable_in_context_after_acceptation(self):
        ...
        self.assertTrue(
            response.context['cookies_notification_shown'],
            "The context variable cookies_notification_shown should be True once accepted")
